...
// Artículos de un tipo (Beitragstyp), opcionalmente filtrados por región.
// GLOBila lo usa para poblar el panel de país cuando explorás por tipo.
...
export async function GET(request, context) {
  try {
    ...
    const where = { beitragstypId: typeId, ...regionWhere };
    ...
    console.error("❌ Error en la API de tipos por artículo:", error);
    return NextResponse.json(
