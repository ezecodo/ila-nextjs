...
export default function LinksManagement() {
  ...
  // Preview: solo links activos, agrupados por categoría
  const activeLinks = links.filter((l) => l.isActive);
  const groupedLinks = Array.isArray(activeLinks)
    ? activeLinks.reduce((acc, link) => {
  ...
  return (
    <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-500 p-4 rounded-r-lg flex items-center justify-between">
              ...
              <FaLink className="text-purple-500" size={24} />
            </div>
        ...
        {/* ===== COLUMNA DERECHA: Preview Móvil ESCALADO ===== */}
          ...
          <div className="sticky top-4">
            ...
            <div className="relative mx-auto w-[260px]">
              ...
              <div className="relative bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl">
                ...
                {/* Pantalla */}
                <div className="relative bg-[#050505] rounded-[2rem] overflow-hidden h-[480px]">
                  {/* Status bar */}
                  <div className="h-8 flex items-end justify-center pb-1">
                    <div className="w-16 h-1 bg-gray-700 rounded-full" />
                  </div>

                  {/* Contenido scrolleable - ESCALADO al 70% */}
                  <div
                  ...
                  >
                    ...
                    >
                      <div className="px-4 pb-8">
                        ...
                        {/* Redes sociales - EXACTO */}
                        <div className="mt-10 flex justify-center gap-4">
                          <div className="w-12 h-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full flex items-center justify-center text-white">
                            <FaInstagram size={20} />
                          </div>
                          <div className="w-12 h-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full flex items-center justify-center text-white">
                            <FaFacebookF size={18} />
