...
export default function SubscriptionPage() {
  ...
  return (
    <div className="prose prose-lg max-w-3xl mx-auto py-10 dark:prose-invert">
      <h1 className="text-3xl font-bold text-red-700 dark:text-red-400 mb-6">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 dark:text-gray-100">
      ...
      <form className="space-y-6">
        ...
        {options.map((opt) => (
          ...
          >
            <input
              ...
              className="h-4 w-4 text-red-600 border-gray-300 dark:border-gray-600 focus:ring-red-600"
            />
            <span>{opt.label}</span>
          </label>
        ))}
        ...
        {selected === "foerder" && (
          <div>
            ...
            <input
              ...
              className="mt-1 p-2 border rounded w-full bg-white dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600"
            />
          </div>
        )}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <label className="text-gray-800 dark:text-gray-200">E-Mail *</label>
            <input
              type="email"
              required
              value={form.email}
